          ...
          {!loginSuccess ? (
            <>
              ...
              <div className="email">
                <section
                  className={`input-container ${
                    valueState.email && focusState.email && "green"
                  } ${errorState.email && "red"}`}
                >
                  <input
                    id="email"
                    type="text"
                  ...
                  {valueState.email && (
                    <span
                      className="cross"
                      onClick={() =>
                        setValueState({ ...valueState, email: "" })
                      }
                    >
                      <HiOutlineX />
                    </span>
                ...
                <span className="wrong-message">
                  {errorState.email && "Invalid Email Id"}
                  {wrongEmail && "Email Id dose not exits, try to sign up"}
                </span>
              </div>
              ...
              <div className="password">
                <section
                  className={`input-container ${
                    valueState.password && focusState.password && "green"
                  } ${errorState.password && "red"}`}
                >
                  <input
                    id="password"
                  ...
                  {valueState.password && (
                    <span
                      className="cross"
                      onClick={() =>
                        setValueState({ ...valueState, password: "" })
                      }
                    >
                      <HiOutlineX />
                    </span>
                ...
                <span className="wrong-message">
                  {errorState.password && "Password should not be blank"}
            ...
            <>
              <section className="success-message">
                ...
                <p className="text">
                  Welcome! {loginUser?.name}. You are successfully logged in!
                </p>
